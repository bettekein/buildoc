...
<div>
    ...
    @if (app()->isLocal())
        <div class="mt-8 p-4 border rounded-lg bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Development Login</h3>
            <div class="grid grid-cols-2 gap-3" x-data>
                <button type="button" @click="$wire.form.email = 'admin@buildoc.test'; $wire.form.password = 'password'"
                ...
                <button type="button" @click="$wire.form.email = 'user@buildoc.test'; $wire.form.password = 'password'"
            ...
            <p class="text-xs text-center text-gray-400 mt-2">Click to fill credentials</p>
        </div>
    @endif
</div>