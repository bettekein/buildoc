                    ...
                    @if(auth()->user()->hasRole('Super Admin'))
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('admin.tenants')" wire:navigate>
                                        テナント管理
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('admin.audits')" wire:navigate>
                                        監査ログ
                                    </x-dropdown-link>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('masters.vehicles')" wire:navigate>
                                    車両マスタ
                                </x-dropdown-link>
